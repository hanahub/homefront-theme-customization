...
class Homestore {
	...
	public function __construct() {
		...
		add_action( 'init',                        array( $this, 'woocommerce_overrides' ) );
	}

	/**
	 * WooCommerce overrides
	 */
	public function woocommerce_overrides() {
		global $storefront_version;

		if ( version_compare( $storefront_version, '2.3.0', '>=' ) && storefront_is_woocommerce_activated() ) {
